    ...
    <View style={styles.container}>
       <View style={styles.header}>
          ...
          <View style={styles.filterRow}>
             <TouchableOpacity style={[styles.filterBtn, filterMode==='MENTORES' && styles.activeBtn]} onPress={()=>setFilterMode('MENTORES')}>
       ...
       {loading ? <ActivityIndicator color="#000080" style={{marginTop:50}}/> : (
          <FlatList
             data={displayedItems}
